              ...
              Container(
                ...
                child: Column(
                  children: [
                   ...
                   photoProvider.isLoading?CircularProgressIndicator():     _buildEmptyState(context)                
                    else
...
Widget buildPhotoGrid(PropertycardFormModel property,photoPicker) {
...
class CustomSheet extends StatelessWidget {
                      ...
                      child: OptionCard(
                        ...
                        model: OptionCardModel(icon: Icons.camera_alt_rounded,
                         ...
                         iconColor:  Colors.blue.shade700, onTap:  () {
                          ...
                          Provider.of<PhotoPickerProvider>(context, listen: false)
                              .pickUpdateImages(ImageSource.camera);
                        },),
                      ),
                    ),
                      ...
                      child: OptionCard(
                        model: OptionCardModel(icon: Icons.photo_library_rounded,
                         title: 'Gallery', color: Colors.purple.shade100,
                          ...
                          Navigator.pop(context);
                          Provider.of<PhotoPickerProvider>(context, listen: false)
                              .pickUpdateImages(ImageSource.gallery);
                        },), title: 'Gallery',
                      ),
                    ),
                  ],
  ...
  //         mainAxisSpacing: 10,
  //       ),
  //       itemCount: property!.photoPath.length,
  //       itemBuilder: (context, index) {
  //         final imageUrl =  property!.photoPath[index];
  //         return Stack(
  //           children: [
  //             ClipRRect(
  //               borderRadius: BorderRadius.circular(8),
  ...
  //               right: 0,
  //               child: GestureDetector(
  //                 onTap: () => photopicker.removeImage(index),
  //                 child: Container(
...
//                 child: Column(
//                   children: [
//                     if (widget.property!.photoPath.isEmpty)
//                     _buildEmptyState(context)
//                     else
//                       _buildPhotoGrid(widget.property!, photoProvider),
//                     _buildAddButton(context),
//                   ],
//                 ),
//               ),
...
//   Widget _buildPhotoGrid(PropertycardFormModel property, PhotoPickerProvider photopicker) {
//     return Padding(
//       padding: const EdgeInsets.all(12),
//       child: GridView.builder(
//         shrinkWrap: true,
...
//   if (index >= 0 && index < widget.property!.photoPath.length) {
//     setState(() {
//       widget.property!.photoPath.removeAt(index);
//     });
//   }
// }
// }
