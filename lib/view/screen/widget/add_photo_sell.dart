...
class AddPhotoSell extends StatelessWidget {
  ...
  void _showCustomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      context: context,
      builder: (context) => const CustomsheetSell(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<PhotoPickerProviderSell>(
  ...
  Widget _buildEmptySellState(BuildContext context) {
  ...
  Widget _buildPhotoGrid(PhotoPickerProviderSell photoProvider) {
    return Padding(
