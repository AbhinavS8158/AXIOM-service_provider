...
return Container(
  ...
  child: CrystalNavigationBar(
    ...
    items: [CrystalNavigationBarItem(  icon: Icons.home,
              unselectedIcon: Icons.home,unselectedColor: Colors.grey,
            ...
            CrystalNavigationBarItem(
              icon: Icons.add,
              unselectedIcon: Icons.add ,unselectedColor: Colors.grey,
              selectedColor: AppColor.forgot,
            ),
            ...
            CrystalNavigationBarItem(
                ...
                unselectedIcon: Icons.assignment,unselectedColor: Colors.grey,
                selectedColor: AppColor.forgot),
            CrystalNavigationBarItem(
              icon: Icons.person,
