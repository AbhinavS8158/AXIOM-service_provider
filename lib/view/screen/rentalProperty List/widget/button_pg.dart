...
class PButtons extends StatelessWidget {
  ...
  const PButtons({super.key, required this.property});
  @override
  Widget build(BuildContext context) {
    final controller = Provider.of<PgFormProvider>(context);
    return Row(
      ...
      children: [
        ElevatedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => UpdatePgForm(property: property,)),
            );
          },
